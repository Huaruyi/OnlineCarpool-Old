  ...
  <body>
	...
	<div id="win" class="easyui-window" title="编辑用户" style="width:500px;height:300px"
	    ...
	    <form id="editForm" method="post">
			...
			修改密码：<input type="text" name="upassword" class="easyui-validatebox" data-options="required:true"/><br/>
  	...
  	<script type="text/javascript">
  		$(function(){
  			...
  			$("#editBtn").click(function(){
  				...
  				/*//表单回显
  				$("#editForm").form("load","/findPassengerById?uid="+rows[0].uid);*/
  			...
  			$("#deleteBtn").click(function(){
  				...
  				$.messager.confirm("提示","确认删除数据吗?",function(value){
  					if(value){
  						...
  						//传递到后台
  						$.post("/deletePassenger",idStr,function(data){
  							if(data.success){
  	  							//刷新datagrid
  	  							$("#list").datagrid("reload");
