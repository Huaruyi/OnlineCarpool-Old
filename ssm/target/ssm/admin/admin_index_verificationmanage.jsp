...
<div data-options="region:'west',title:'系统菜单',split:true" style="width:200px;">
    <div id="aa" class="easyui-accordion" style="width:193px;" data-options="border:0,multiple:true" >
        <div title="审核管理" data-options="iconCls:'icon-save'" style="overflow:auto;padding:10px;">
            <ul>
                <li><a href="javascript:void(0)" pageUrl="admin_passenger_verify.jsp">乘客审核</a></li>
                <li><a href="javascript:void(0)" pageUrl="admin_driver_verify.jsp">司机审核</a></li>
                <li><a href="javascript:void(0)" pageUrl="admin_driverCar_verify.jsp">车辆审核</a></li>
            </ul>
        </div>
    </div>
</div>
