...
<div data-options="region:'north',split:true" style="height:80px;">
    ...
    <!-- logo -->
    <div id="logo">
        <img src="../images/logo.png" width="195" height="60"/>
    </div>

    <!-- 登录用户信息 -->
    <div id="loginDiv" style="position: absolute;right: 20px;top: 20px;">
        欢迎你，[超级管理员]${root.aname},你使用[192.156.21.22]IP登录!
    </div>
...
<div data-options="region:'west',title:'系统菜单',split:true" style="width:200px;">
    <div id="aa" class="easyui-accordion" style="width:193px;" data-options="border:0,multiple:true" >
        <div title="注册审核" data-options="iconCls:'icon-save'" style="overflow:auto;padding:10px;">
            <ul>
                <li><a href="javascript:void(0)" pageUrl="admin/admin_passenger_verify.jsp">乘客审核</a></li>
                <li><a href="javascript:void(0)" pageUrl="admin/admin_driver_verify.jsp">司机审核</a></li>
                <li><a href="javascript:void(0)" pageUrl="admin/admin_driverCar_verify.jsp">车辆审核</a></li>
            </ul>
        </div>
        <div title="用户管理" data-options="iconCls:'icon-reload',selected:true" style="padding:10px;">
            <ul>
                <li><a href="javascript:void(0)" pageUrl="admin/admin_passenger_manage.jsp">乘客管理</a></li>
                <li><a href="javascript:void(0)" pageUrl="admin/admin_driver_manage.jsp">司机管理</a></li>
            </ul>
        </div>
        <div title="拼车管理" data-options="iconCls:'icon-reload',selected:true" style="padding:10px;">
            <ul>
                <li><a href="javascript:void(0)" pageUrl="admin/admin_route_manage.jsp">路线管理</a></li>
                <li><a href="javascript:void(0)" pageUrl="admin/admin_evaluate_manage.jsp">评价审核</a></li>
            </ul>
        </div>
    </div>
</div>
