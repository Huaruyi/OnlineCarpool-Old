            ...
            <div class="tabbable" id="tabs-592780">
                <ul class="nav nav-tabs">
                    <li>
                        ...
                        <script>
                            function publish() {
                                window.location.href="passengerPublishList"
                            }
                        </script>
                    </li>
                    <li class="active">
                                ...
                                <table class="table table-hover table-bordered" contenteditable="false">
                                    ...
                                    <c:forEach items="${passengerPublishList}" var="bl">
                                        <tr class="warning">
                                            ...
                                            <td>
                                                <c:if test="${bl.bookdetail.uid == user.uid}">
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form id="addPublishForm" action="passengerAddPublish?bid=${bl.bid}&uid=${user.uid}" method="post">
                                        ...
                                        <nav aria-label="Page navigation">
                                            <ul class="pagination">
                                                ...
                                                <c:if test="${allPassengerPublishPage.pageNum != allPassengerPublishPage.firstPage}">
                                                    <li>
                                                        <a href="passengerBookList?page=${allPassengerPublishPage.firstPage}"><span aria-hidden="true">首页</span></a>
                                                    </li>
                                                </c:if>
                                                <c:if test="${allPassengerPublishPage.pageNum == allPassengerPublishPage.firstPage}">
                                                    <li  class="disabled">
                                                ...
                                                <c:if test="${allPassengerPublishPage.hasPreviousPage}">
                                                    <li>
                                                        <a href="passengerBookList?page=${allPassengerPublishPage.pageNum-1}" aria-label="Previous"><span aria-hidden="true">&laquo;</span></a>
                                                    </li>
                                                </c:if>
                                                <!-- 页码  -->
                                                <!-- 当总页数小于等于7时，显示页码1...7页 -->
                                                <c:if test="${allPassengerPublishPage.pages<=7}">
                                                    <c:forEach begin="1" end="${allPassengerPublishPage.pages}" var="i">
                                                        <li <c:if test="${allPassengerPublishPage.pageNum==i }">class="active"</c:if>>
                                                            <a href="passengerBookList?page=${i}">${i}</a>
                                                        </li>
                                                    </c:forEach>
                                                </c:if>
                                                <!-- 当总页数大于7时 -->
                                                <c:if test="${allPassengerPublishPage.pages>7}">
                                                    ...
                                                    <c:if test="${allPassengerPublishPage.pageNum<=4}">
                                                        ...
                                                        <li
                                                            ...
                                                            <a href="passengerBookList?page=${allPassengerPublishPage.pages}">${allPassengerPublishPage.pages}</a>
                                                        </li>
                                                    </c:if>
                                                    ...
                                                    <c:if test="${allPassengerPublishPage.pageNum>4}">
                                                        <c:if test="${allPassengerPublishPage.pageNum<allPassengerPublishPage.pages-3}">
                                                            <li>
                                                                <a href="passengerBookList?page=${1}">${1}</a>
                                                            </li>
                                                            <li><a href="#">...</a></li>
                                                    ...
                                                    <c:if test="${allPassengerPublishPage.pageNum>allPassengerPublishPage.pages-4}">
                                                        <li><a href="passengerBookList?page=${1}">${1}</a>
                                                        </li>
                                                ...
                                                <c:if test="${allPassengerPublishPage.hasNextPage}">
                                                    <li>
                                                        <a href="passengerBookList?page=${allPassengerPublishPage.pageNum+1}" aria-label="Next"><span aria-hidden="true">&raquo;</span></a>
                                                    </li>
                                                </c:if>
                                                <%--尾页--%>
                                                <c:if test="${allPassengerPublishPage.pageNum != allPassengerPublishPage.lastPage}">
                                                    <li>
                                                        <a href="passengerBookList?page=${allPassengerPublishPage.lastPage}"><span aria-hidden="true">尾页</span></a>
                                                    </li>
                                                </c:if>
                                                <c:if test="${allPassengerPublishPage.pageNum == allPassengerPublishPage.lastPage}">
                                                    <li  class="disabled">
