...
<body>
    <div class="container">
        ...
        <form id="form" action="/passengerPublishBook?id=2" method="post" class="form-horizontal" onsubmit="Hint()" style="margin-top: 5px;">
            <script>
                function Hint() {
                    alert("发起预定拼车成功");
                }
            ...
            <div class="form-group">
                <label for="begintime" class="col-sm-2 control-label">出发时间</label>
                <div class="col-sm-6">
