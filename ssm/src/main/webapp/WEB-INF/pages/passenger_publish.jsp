...
<body>
    <div class="container">
        ...
        <form id="form" action="/passengerPublishBook?id=1" method="post" class="form-horizontal" onsubmit="Hint()" style="margin-top: 5px;">
            <script>
                function Hint() {
                    alert("发起实时拼车成功");
                }
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <%--使用了 bootstrap-selected插件 可以模糊搜索   加入selectpicker用于启用bootstrap-selected  模糊搜索用：data-live-search="true"--%>
            ...
            <div class="form-group opt">
                <label for="inlineRadio1" class="col-sm-2 control-label">座位数</label>
                <div class="col-sm-6">
                    <label class="radio-inline"> <input type="radio" name="bookdetail.bdseat" checked="checked" id="inlineRadio1" value="1">
                        1
                    </label> <label class="radio-inline"> <input type="radio" name="bookdetail.bdseat" id="inlineRadio2" value="2">
                        2
                </label>
                </div>
            </div>
