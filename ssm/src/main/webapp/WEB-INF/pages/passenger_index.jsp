            ...
            <div class="tabbable" id="tabs-592780">
                <ul class="nav nav-tabs">
                    ...
                    <li>
                        ...
                        <script>
                            function TobookList() {
                                window.location.href="passengerBookList";
                            }
                        </script>
                    </li>
                </ul>
                                ...
                                <table class="table table-hover table-bordered" contenteditable="false">
                                    ...
                                    <c:forEach items="${passengerPublishList}" var="pl">
                                        <tr class="success">
                                            ...
                                            <td>
                                                <c:if test="${pl.bookdetail.uid==user.uid}">
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form id="addPublishForm" action="passengerAddPublish" method="post" onsubmit="Hint()">
                                                                    <script>
                                                                        function Hint() {
                                                                            alert("加入拼车成功");
                                                                        }
                                                                    ...
                                                                    <div class="form-group opt">
                                                                        <div class="col-sm-6">
                                                                            <input type="hidden" name="bid" id="bid" value="${pl.bid}"><br>
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group opt">
                                                                        ...
                                                                        <div class="col-sm-6">
                                                                            ...
                                                                            <c:if test="${pl.bookdetail.bdseat == 1}">
                                                ...
                                                <div class="modal fade" id="detailModal" tabindex="-1" role="dialog" aria-labelledby="detailModalLabel">
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <h4>司机信息</h4>
                                                                <c:if test="${empty pl.driver}">
                                                                    司机还未加入
                                                                </c:if>
                                                                <c:if test="${not empty pl.driver}">
                                                                    姓名：${pl.driver.dname}<br>
                                                                    电话：${pl.driver.dphone}<br>
                                                                    拼车：${pl.driver.dtimes}次<br>
                                                                    评价：${pl.driver.devaluate}分<br>
                                                                </c:if>
                                                                ...
                                                                <h4>路线信息</h4>
                                                                    拼车线路：${pl.route.rdeparture} &nbsp;→&nbsp; ${pl.route.rdestination}<br>
                                                                    信号灯数：${pl.route.rsignal}个<br>
                                                                    预计里程：${pl.route.rdistance}公里<br>
                                                            </div>
                                                            <div class="modal-footer">
                                        ...
                                        <nav aria-label="Page navigation">
                                            <ul class="pagination">
                                                ...
                                                <c:if test="${allPassengerPublishPage.pageNum != allPassengerPublishPage.firstPage}">
                                                    <li>
                                                        <a href="passengerPublishList?page=${allPassengerPublishPage.firstPage}"><span aria-hidden="true">首页</span></a>
                                                    </li>
                                                </c:if>
                                                <c:if test="${allPassengerPublishPage.pageNum == allPassengerPublishPage.firstPage}">
                                                    <li  class="disabled">
                                                ...
                                                <c:if test="${allPassengerPublishPage.hasPreviousPage}">
                                                    <li>
                                                        <a href="passengerPublishList?page=${allPassengerPublishPage.pageNum-1}" aria-label="Previous"><span aria-hidden="true">&laquo;</span></a>
                                                    </li>
                                                </c:if>
                                                <!-- 页码  -->
                                                <!-- 当总页数小于等于7时，显示页码1...7页 -->
                                                <c:if test="${allPassengerPublishPage.pages<=7}">
                                                    <c:forEach begin="1" end="${allPassengerPublishPage.pages}" var="i">
                                                        <li <c:if test="${allPassengerPublishPage.pageNum==i }">class="active"</c:if>>
                                                            <a href="passengerPublishList?page=${i}">${i}</a>
                                                        </li>
                                                    </c:forEach>
                                                </c:if>
                                                <!-- 当总页数大于7时 -->
                                                <c:if test="${allPassengerPublishPage.pages>7}">
                                                    ...
                                                    <c:if test="${allPassengerPublishPage.pageNum<=4}">
                                                        ...
                                                        <li
                                                            ...
                                                            <a href="passengerPublishList?page=${allPassengerPublishPage.pages}">${allPassengerPublishPage.pages}</a>
                                                        </li>
                                                    </c:if>
                                                    ...
                                                    <c:if test="${allPassengerPublishPage.pageNum>4}">
                                                        <c:if test="${allPassengerPublishPage.pageNum<allPassengerPublishPage.pages-3}">
                                                            <li>
                                                                <a href="passengerPublishList?page=${1}">${1}</a>
                                                            </li>
                                                            <li><a href="#">...</a></li>
                                                    ...
                                                    <c:if test="${allPassengerPublishPage.pageNum>allPassengerPublishPage.pages-4}">
                                                        <li><a href="passengerPublishList?page=${1}">${1}</a>
                                                        </li>
                                                ...
                                                <c:if test="${allPassengerPublishPage.hasNextPage}">
                                                    <li>
                                                        <a href="passengerPublishList?page=${allPassengerPublishPage.pageNum+1}" aria-label="Next"><span aria-hidden="true">&raquo;</span></a>
                                                    </li>
                                                </c:if>
                                                <%--尾页--%>
                                                <c:if test="${allPassengerPublishPage.pageNum != allPassengerPublishPage.lastPage}">
                                                    <li>
                                                        <a href="passengerPublishList?page=${allPassengerPublishPage.lastPage}"><span aria-hidden="true">尾页</span></a>
                                                    </li>
                                                </c:if>
                                                <c:if test="${allPassengerPublishPage.pageNum == allPassengerPublishPage.lastPage}">
                                                    <li  class="disabled">
