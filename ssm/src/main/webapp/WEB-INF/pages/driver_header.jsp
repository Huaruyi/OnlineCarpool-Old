    ...
    <div class="col-md-4" style="padding-top:20px">
        <ol class="list-inline">
            ...
            <c:if test="${not empty driver}">
                <%--<c:if test="${driver.state == 1}">
                    实名认证未通过
                </c:if>--%>
                <li><a href="javascript:;" style="text-decoration: none;color: #0C0C0C">你好，${driver.dname}</a></li>
                <li><a href="logout">退出</a></li>
                <li><a href="driverCarpooling">我的拼车</a></li>
                <li><a href="driverSpace">个人中心</a></li>
                <li><a href="#">我的订单</a></li>
